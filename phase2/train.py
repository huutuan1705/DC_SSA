...
def train_model(model, args):
    ...
    for i_epoch in range(args.epochs):
        ...
        top1_eval, top5_eval, top10_eval = evaluate_model(model=model, dataloader_test=dataloader_test)
        if top5_eval > top5:
            top5 = top5_eval
        ...
        with open("results_log.txt", "a") as f:
            f.write("Epoch {:d} | Top1: {:.5f} | Top5: {:.5f} | Top10: {:.5f}\n".format(
                i_epoch+1, top1_eval, top5_eval, top10_eval))